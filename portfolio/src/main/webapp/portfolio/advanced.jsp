...
<%
    ...
    // 15분이 지난 게시물 삭제
    String deleteSql = "DELETE FROM AdvancedMatches WHERE CREATED_AT < SYSTIMESTAMP - INTERVAL '15' MINUTE";
...
<body>
    ...
    <section class="title"><br>
        <p>고급 실력을 가지신 분들이 팀을 꾸릴 수 있습니다.</p>
    ...
    <section class="main-section">
        ...
        <div class="match-listing">
            <ul>
                <%
                try {
                    String sql = "SELECT * FROM (SELECT MATCH_ID, TITLE, DESCRIPTION, CONTACT, USERNAME, CREATED_AT, ROW_NUMBER() OVER (ORDER BY MATCH_ID) AS rn FROM AdvancedMatches) WHERE rn BETWEEN ? AND ?";
        ...
        <div class="pagination">
            <%
            // 페이지 수 계산
            String countSql = "SELECT COUNT(*) FROM AdvancedMatches";
        ...
        %>
            <div class="post-match">
                <h3>매치 게시하기</h3>
                <form action="postAdvancedAction.jsp" method="post">
