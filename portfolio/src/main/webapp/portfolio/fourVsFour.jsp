...
<%
    ...
    int endOffset = offset + pageSize - 1; // 종료 OFFSET
 	...
 	// 15분이 지난 게시물 삭제
    String deleteSql = "DELETE FROM FourVsFourMatches WHERE CREATED_AT < SYSTIMESTAMP - INTERVAL '15' MINUTE";
    ...
    <section class="main-section">
        <div class="match-listing">
            ...
            <ul>
                <%
                try {
                    // FourVsFourMatches 테이블에서 데이터 가져오기
                    String sql = "SELECT * FROM (SELECT MATCH_ID, TITLE, DESCRIPTION, CONTACT, USERNAME, CREATED_AT, ROW_NUMBER() OVER (ORDER BY MATCH_ID) AS rn FROM FourVsFourMatches) WHERE rn BETWEEN ? AND ?";
        ...
        <div class="pagination">
            <%
            // 페이지 수 계산
            String countSql = "SELECT COUNT(*) FROM FourVsFourMatches";
        ...
        %>
            <div class="post-match">
                <h3>매치 게시하기</h3>
                <form action="postFourVsFourAction.jsp" method="post">
